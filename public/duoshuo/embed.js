...
function ua_sskadmin(e) {
  ...
  if (e.user_id == duoshuoQuery['short_name']) {
    if (ua_checkMobile()) {
      ssk =
        '<span class="ua"><span class="sskadmin"><i class="fa fa-star"></i>博主</span></span><br><br>';
    } else {
...
function ua_html(e) {
  ...
  } else if ((r = e.match(/BIDUBrowser([\d]*)\/([^\s]+)/gi))) {
    var r1 = r[0].split('/');
  ...
  } else if ((r = e.match(/UCBrowser([\d]*)\/([^\s]+)/gi))) {
    var r1 = r[0].split('/');
    outputer = '<span class="ua_ucweb"><i class="fa fa-globe"></i> UCBrowser' + ' ' + r1[1];
  ...
  if (
    ...
    (o.getCookie = function (e) {
      for (var a, i, r, n = ' ' + e + '=', o = t.cookie.split(';'), d = 0; d < o.length; d++)
        if (
          ((a = ' ' + o[d]), (i = a.indexOf(n)), i >= 0 && i + n.length == (r = a.indexOf('=') + 1))
        )
    ...
    (o.cssProperty = function (e, s) {
      ...
      for (
        var i = ['Moz', 'Webkit', 'ms'], e = e.charAt(0).toUpperCase() + e.substr(1), r = 0;
        r < i.length;
        r++
      )
    ...
    var c,
      ...
      T = function () {
        ...
        return e
          ? { jwt: e }
          : c.remote_auth
          ? { short_name: c.short_name, remote_auth: c.remote_auth }
          : s;
      },
      q = function () {
      ...
      S = (e.DUOSHUO = {
        ...
        elapsedTime: function (e) {
          ...
          return 10 > a
            ...
            ? Math.round(a / 60) + '分钟前'
            : 86400 > a
            ? Math.round(a / 3600) + '小时前'
            : (s.getFullYear() == t.getFullYear() ? '' : t.getFullYear() + '年') +
              (t.getMonth() + 1) +
              '月' +
              t.getDate() +
              '日';
      ...
      P = (S.support = (function () {
        ...
        return (
          (r.ie6 = !f && 'undefined' == typeof s.style.maxHeight),
      ...
      E = (S.openDialog = function (e) {
        return (
          S.dialog !== s && S.dialog.el.remove(), (S.dialog = new st.Dialog(et.dialog(e)).open())
        );
      }),
      L = (S.smilies = {});
    S.require = (function () {
      ...
      return (
        'undefined' != typeof jQuery &&
          jQuery.fn.jquery >= '1.5' &&
          ((s['embed.compat'] = !0), (S.jQuery = e.jQuery)),
        function (e, a) {
          if ('string' == typeof e)
            s[e]
              ? a()
              : o.injectScript(t(e), function () {
                  (s[e] = !0), a();
                });
        ...
        ajax: function (e, t, i, r, n) {
          ...
          function l(e, t, s) {
            ...
            o
              ...
              : 'parseerror' === l
              ? C.error('解析错误: ' + s)
              : (C.error('出错啦(' + a.code + '): ' + a.errorMessage),
                n && n(a),
          ...
          if (h) {
            ...
            if (v) {
              var g;
              return (
                m.open(e, a() + '/api/' + t + '.json' + ('GET' == e ? '?' + o.param(i) : ''), !0),
                (m.withCredentials = !0),
                m.setRequestHeader(
                  'Content-Type',
        ...
        if (
          (t.visitor &&
            (!nt.data &&
              t.visitor.user_id &&
              e.Notification &&
              A.send({ logged_user_id: t.visitor.user_id }),
            nt.reset(t.visitor)),
          t.site && (rt.reset(t.site), D.save('ds_site_' + c.short_name, t.site)),
          !S.theme && rt.data.theme && n(rt.data.theme),
          t.lang && (o.extend(z, t.lang), D.save('ds_lang_' + c.short_name, t.lang)),
          t.stylesheets)
        )
    ...
    var J = (S.Event = H.extend({
      ...
      F = V.extend({
        toJSON: function () {
          ...
          return (
            (e.theAuthor =
              (ct[this.data.author_id] && ct[this.data.author_id].data) || this.data.author),
    ...
    var Z = {
        ...
        bindUrl: function (e) {
          return (
            ...
            e +
            '/' +
            x(c.sso && c.sso.login ? { sso: 1, redirect_uri: c.sso.login } : null, T())
          );
        },
        logoutUrl: function () {
          return (
            a() +
            '/logout/' +
            x(c.sso && c.sso.logout ? { sso: 1, redirect_uri: c.sso.logout } : null)
          );
        },
      },
      ...
      et = (S.templates = {
        ...
        loginItem: function (e, t) {
          ...
          return (
            ...
            '">' +
            S.serviceNames[e] +
            (nt.data.social_uid[e] ? ' <span class="ds-icon ds-icon-ok"></span>' : '') +
            '</a></li>'
          );
        },
      }),
    ...
    (et.commentList = function (e) {
        ...
        return (
          e.post &&
            ...
            (t +=
              ...
              et.userAnchor(e.post.theAuthor || e.post.author) +
              et.timeAnchor(e.post.created_at, e.post.url)),
            e.index >= 0 &&
              (t +=
                '<div class="ds-ctx-nth" title="' +
                S.fullTime(e.post.created_at) +
                '">' +
                (e.index + 1) +
                z.floor +
                '</div>'),
            ...
            e.index >= 0 &&
              ((t += '　　　　　　　<div class="ds-comment-actions'),
      ...
      (et['dialog-ask-for-auth'] = function () {
        var e =
          '<h2>社交帐号登录</h2><ul class="ds-service-list">' +
          et.serviceList(X) +
          '</ul><ul class="ds-service-list ds-additional-services">' +
          et.serviceList(K) +
          '</ul>';
        return e;
      }),
      (et['dialog-bind-more'] = function () {
        var e =
          '<h2>绑定更多帐号</h2><ul class="ds-service-list">' +
          et.serviceBindList(X) +
          '</ul><ul class="ds-service-list ds-additional-services">' +
          et.serviceBindList(K) +
          '</ul><div style="clear:both"></div>';
        return e;
      }),
      (et['dialog-qrcode'] = function (e) {
        var t =
          '<h2>微信扫一扫，分享到朋友圈</h2><div class="ds-share-qrcode" style="text-align:center;"><img src="' +
          e.qrcode_url +
          '" alt="' +
          e.url +
          '"></div>';
      ...
      (et['dialog-reposts'] = function (e) {
        var t =
          ...
          u(e.post.theAuthor.name) +
          '</strong>: ' +
          e.post.message +
          '</div><form>' +
          tt({ post_id: e.post.post_id }) +
          '<div class="ds-textarea-wrapper"><textarea name="message" title="Ctrl+Enter快捷提交" placeholder="' +
          u(z.repost_reason) +
          '">' +
          u(e.repostMessage) +
          '</textarea><pre class="ds-hidden-text"></pre>';
        return (
          (t += '</div><div class="ds-actions">'),
          e.service
            ? (t += tt({ 'service[]': e.service }))
      ...
      (et.hotPosts = function (e) {
        ...
        if (s)
          for (var a, i = -1, r = s.length - 1; r > i; )
            (a = s[(i += 1)]), (t += et.post({ post: a, options: e.options }));
        return (t += '</ul>');
      }),
      ...
      (et.likeTooltip = function (e) {
        ...
        for (var s in e.services)
          t +=
            ...
            a() +
            '/share-proxy/?' +
            o.param({ service: s, thread_id: e.thread_id }) +
            '">' +
            e.services[s] +
            '</a></li>';
        return (t +=
      ...
      (et.meta = function (e) {
        ...
        return (
          e.user_vote > 0 && (t += ' ds-thread-liked'),
      ...
      (et.notify = function (e) {
        ...
        return (
          e.comments || (t += ' style="display:none;"'),
          (t +=
        ...
        if (
          ...
          r.url
            ? ((t +=
                ...
                '" '),
              r.user_id &&
                (t += ' onclick="this.href=\'' + a() + '/user-url/?user_id=' + r.user_id + '\';"'),
              (t += ' rel="nofollow" target="_blank"'),
              r.user_id && (t += ' data-user-id="' + r.user_id + '"'),
              (t += '>' + u(r.name) + '</a>' + ua_build_html(e)))
            : ((t += '<span class="ds-user-name"'),
              r.user_id && (t += ' data-user-id="' + r.user_id + '"'),
              ...
              (o = n[(d += 1)]),
                1 == d &&
                  ...
                  (t +=
                    ...
                    (s.parents.length - 2) +
                    '条评论</a></li>'),
                (t += et.ctxPost({ post: o, index: d, hidden: d && d < s.parents.length - 1 }));
          t += '</ol>';
        }
        if (
          ((t += '<p>'),
          s.parents.length >= i.max_depth &&
            (!i.show_context || i.max_depth > 1) &&
            s.parent_id &&
            lt[s.parent_id] &&
            (t +=
              ...
              '">' +
              z.reply_to +
              u(lt[s.parent_id].toJSON().author.name) +
              ': </a>'),
            ...
            ? ((t +=
              ...
              s.privileges['delete'] &&
                (t +=
                  ...
                  z['delete'] +
                  '</a>'))
            : ('qqt' == s.source || 'weibo' == s.source) &&
              ((t += '<a class="ds-weibo-comments" href="javascript:void(0);">' + z.comments),
              s.type.match(/\-comment$/) ||
                (t += '(<span class="ds-count">' + s.comments + '</span>)'),
              (t += '</a><a class="ds-weibo-reposts" href="javascript:void(0);">' + z.reposts),
              s.type.match(/\-comment$/) ||
                (t += '(<span class="ds-count">' + s.reposts + '</span>)'),
              (t += '</a>')),
          (t += '</div></div></div>'),
          i.max_depth > 1 &&
            (s.childrenArray || s.children) &&
            'weibo' != s.source &&
            'qqt' != s.source)
        ) {
          ...
          if (c)
            for (var s, d = -1, p = c.length - 1; p > d; )
              (s = c[(d += 1)]), (t += et.post({ post: s, options: i }));
          t += '</ul>';
        }
        return (t += '</li>');
      }),
              ...
              if (
                ...
                if (n)
                  for (var o, d = -1, l = n.length - 1; l > d; )
                    (o = n[(d += 1)]),
                      (t +=
                        ' <li> <div class="ds-reads-dumb"></div> <div class="ds-reads-pic-wrap" style="background-image:url(' +
                        o +
                        ');"></div> </li> ');
                (t += ' </ul> </div> <div class="ds-reads-info"> '),
                  1 == a.type && (t += ' <span class="ds-reads-app-special">打开头条阅读</span> '),
                  (t +=
                    ' <span class="ds-reads-date" data-date="' + a.timeStamp + '"></span> </div> ');
              } else
                (t += ' <div class="ds-reads-desc '),
                  a.imgs.length || (t += 'ds-reads-only'),
                  (t +=
                    '"> <div class="ds-reads-title">' +
                    a.title +
                    '</div> <div class="ds-reads-info"> '),
                  1 == a.type && (t += ' <span class="ds-reads-app-special">打开头条阅读</span> '),
                  (t +=
                    ' <span class="ds-reads-date" data-date="' +
                    a.timeStamp +
                    '"></span> </div> </div> '),
                  a.imgs.length &&
                    ((t +=
                      ' <div class="ds-reads-pic-right"> <div class="ds-reads-dumb"></div> <div class="ds-reads-pic-wrap" style="background-image:url(' +
                      a.imgs[0] +
                      ');"> '),
                    a.hasVideo &&
                      (t +=
                        ' <div class="ds-reads-vid-info"><span>' +
                        a.videoDuration +
                        '</span></div> '),
                    (t += ' </div> </div> ')),
                  (t += ' ');
      ...
      (et.replybox = function (e) {
        ...
        if (
          ...
          (t += '</div>'),
          (t +=
            '<div class="ds-post-toolbar"><div class="ds-post-options ds-gradient-bg"><span class="ds-sync">'),
        ...
        return (
          ...
          (t +=
            ...
            u(z.post) +
            '</button><div class="ds-toolbar-buttons">'),
          e.options.use_smilies &&
            (t += '<a class="ds-toolbar-button ds-add-emote" title="插入表情"></a>'),
          e.options.use_images &&
            e.options.parse_html_enabled &&
            (t += '<a class="ds-toolbar-button ds-add-image" title="插入图片"></a>'),
          (t += '</div></div>'),
          (t += '</form></div>')
        );
      }),
      ...
      (et.shareWidget = function (e) {
        var t =
            '<div class="ds-share-icons"> <div class="ds-share-icons-inner"> <ul class="ds-share-icons-16"> ',
          s = e.services;
        if (s)
          for (var a, i = -1, r = s.length - 1; r > i; )
            (a = s[(i += 1)]),
              (t +=
                ' <li> <a class="ds-' +
                a +
                '" href="javascript:void(0);" data-service="' +
                a +
                '">' +
                S.sourceName[a] +
                '</a> </li> ');
        return (t +=
          ' </ul> </div> <div class="ds-share-icons-footer">' + e.copyright + '</div></div>');
      }),
        ...
        return (
          (e += nt.data.url
            ? '<a class="ds-visitor-name" href="' +
              ...
              u(nt.data.name) +
              '</a>'
            : '<span class="ds-visitor-name">' + u(nt.data.name) + '</span>'),
          (e +=
      ...
      S.require('embed.compat', function () {
        ...
        function u() {
          ...
          t.selection &&
            ...
            s &&
              ...
              (r = n.createTextRange()),
              r.collapse(!1),
              a.compareEndPoints('StartToEnd', r) > -1
                ? (o = d = i)
                : ((o = -a.moveStart('character', -i)),
                  (o += e.slice(0, o).split('\n').length - 1),
                  a.compareEndPoints('EndToEnd', r) > -1
                    ? (d = i)
                    : ((d = -a.moveEnd('character', -i)),
                      (d += e.slice(0, d).split('\n').length - 1))))),
            H(n).data('ds-range-start', o).data('ds-range-end', d);
        }
        function p(e) {
          return (
            P.touch && e.addClass('ds-touch'),
        ...
        function b(t, s) {
          ...
          return e.open(
            s +
              (-1 == s.indexOf('?') ? '?' : '&') +
              o.param({ origin: h.origin || 'http://' + h.host }),
            '_blank',
            'width=' + a[0] + ',height=' + a[1] + ',toolbar=no,menubar=no,location=yes',
          );
        }
        function y(e) {
        ...
        function x(e, t, s, a) {
          function i() {
            ...
            return a || l.find('[type=checkbox]:checked')[0]
              ? (R.post('posts/repost', S.toJSON(l), e), o.close(), !1)
              : (alert('还没有选发布到哪儿呢'), !1);
          }
          function r() {
            var e = this.value;
        ...
        function T(e) {
                ...
                tmpl: function (e) {
                  return e.thread
                    ? '<li data-thread-id="' +
                        e.thread.thread_id +
                        '">' +
                        H.map(e.authors, et.userAnchor).join('、') +
                        ' 在 <a class="ds-read" href="' +
                        e.thread.url +
                        '#comments" target="_blank">' +
                        _(e.thread.title || '无标题') +
          ...
          var a = s.el
            .find('.ds-unread-list')
            .delegate('.ds-delete', 'click', function () {
        ...
        function M(e, t, s) {
          return e.find('.ds-post[data-post-id=' + t.data.post_id + ']')[0]
            ? void 0
            : (e.find('.ds-post-placeholder').remove(),
              H(et.post({ post: t.toJSON(), options: s }))
                .hide()
                ['asc' == s.order ? 'appendTo' : 'prependTo'](e)
                .slideDown(function () {}));
        }
        function U(e, t) {
          function s() {
          ...
          function i() {
            ...
            return (
              R.post('posts/remove', { post_id: t.attr('data-post-id') }),
          ...
          function n() {
            ...
            var e = H(this).closest('.ds-post-self');
            return (
              R.post('posts/report', { post_id: e.attr('data-post-id') }),
              alert('感谢您的反馈！'),
              !1
            );
          }
          function o() {
            ...
            if (a.hasClass('ds-reply-active'))
              ...
              h
                ? h.actionsBar.removeClass('ds-reply-active')
                : ((h = new st.Replybox(e)),
                  h.render(!0).el.addClass('ds-inline-replybox').detach()),
                h.el.find('[name=parent_id]').val(i.attr('data-post-id')),
                h.el
                  .show()
                  .appendTo(s.closest('.ds-ctx-body, .ds-comment-body'))
                  .find('textarea')
                  .focus(),
                (h.actionsBar = a.addClass('ds-reply-active')),
                t.max_depth <= 1
                  ? (h.postList = e.postList.el)
                  : ((h.postList = i.siblings('.ds-children')),
                    h.postList[0] ||
                      (h.postList = H('<ul class="ds-children"></ul>').insertAfter(i)));
            }
            return !1;
          }
          function d() {
            ...
            return i[0]
              ? (i.remove(), !1)
              : ((i = H('<ul class="ds-children"></ul>').insertAfter(s)),
                R.get('posts/listComments', B({ post_id: a }), e),
                !1);
          }
          function l() {
            var t = H(this).closest('.ds-post-self'),
            ...
            function t() {
              ...
              try {
                if (a.hasClass('ds-comment-context'))
                  K.attr('id', 'ds-ctx-bubble')
                    .attr('data-post-id', a.attr('data-post-id'))
                    .html(
                      '<ul id="ds-ctx">' +
                        et.ctxPost({ post: lt[a.attr('data-parent-id')].toJSON() }) +
          ...
          var h;
          this.delegate('a.ds-post-likes', 'click', s)
            .delegate('a.ds-post-repost', 'click', a)
            .delegate('a.ds-post-delete', 'click', i)
            .delegate('a.ds-post-report', 'click', n)
            .delegate('a.ds-post-reply', 'click', o)
            .delegate('a.ds-weibo-comments', 'click', d)
            .delegate('a.ds-weibo-reposts', 'click', l)
            .delegate('a.ds-expand', 'click', c),
            P.touch ||
              this.delegate(
                'a.ds-comment-context, .ds-avatar, .ds-user-name',
                'mouseenter',
                u,
              ).delegate('a.ds-comment-context, .ds-avatar, .ds-user-name', 'mouseleave', p);
        }
        function B(e) {
          var s = {
        ...
        e.postMessage &&
          (e.addEventListener
            ...
            : e.attachEvent && e.attachEvent('onmessage', g)),
          (S.scrollTo = function (e) {
            var t = e.offset().top;
            (t < V.scrollTop() || t > V.scrollTop() + V.height()) &&
              H('html, body').animate({ scrollTop: t - 40 }, 200, 'swing');
          }),
          (S.toJSON = function (e) {
            var t = /\r?\n/g,
              s =
              ...
              i = e
                ...
                .filter(function () {
                  return (
                    this.name &&
                    !this.disabled &&
                    (this.checked || a.test(this.nodeName) || s.test(this.type))
                  );
                })
                .map(function (e, s) {
                  var a = H(this).val();
          ...
          (S.resetNotify = function () {
            var e = H('#ds-notify'),
              s = ot.data;
            e[0] ||
              (e = H('<div id="ds-notify"></div>')
                .css(
                  {
                    hidden: { display: 'none' },
                    'top-right': { top: '24px', right: '24px' },
                    'bottom-right': { bottom: '24px', right: '24px' },
                  }[rt.data.notify_position],
                )
                .delegate('.ds-notify-unread a', 'click', function () {
              ...
              e
                .html(et.notify(s))
                [
                  (!s.comments && !s.notifications) ||
                  'hidden' === rt.data.notify_position ||
                  H('.ds-dialog')[0]
                    ? 'hide'
                    : 'show'
                ]();
          ...
          (st.Replybox.prototype = {
            render: function (e) {
              function s(e) {
                e.data('submitting', !0),
                  (e.find('.ds-post-button').addClass('ds-waiting').html(z.posting)[0].disabled =
                    !0);
              }
              function a(e) {
                e.data('submitting', !1),
                  (e.find('.ds-post-button').removeClass('ds-waiting').html(z.post)[0].disabled =
                    !1);
              }
              var i = this,
                o = i.embedThread,
              ...
              var g = (i.el = H(et.replybox(h)).click(p)),
                ...
                k = f(b.find('textarea'))
                  ...
                  .keyup(n)
                  .keyup(d)
                  .bind('focus mousedown mouseup keyup', u),
                w = g.find('.ds-add-emote').click(function (e) {
                  var s = S.smiliesTooltip;
                  return (
                    w.toggleClass('ds-expanded').hasClass('ds-expanded')
                      ? (s ||
                          ((s = S.smiliesTooltip = new st.SmiliesTooltip()),
                          s.render(),
                          S.require('smilies', function () {
                            s.reset('微博-默认');
                          })),
                ...
                x =
                  (g.find('.ds-add-image').click(function (e) {
                    var s = k[0],
                      a = s.value,
                      i = '请输入图片地址',
                      r = '<img src="' + i + '" />';
                    if (t.selection) {
                      (s.value =
                        a.substring(0, k.data('ds-range-start')) +
                        r +
                        a.substring(k.data('ds-range-end'), a.length)),
                ...
                T = function (e, t) {
                  ...
                  if ((a.find('.ds-icons-32 a').click(l), !c.deny_anonymous)) {
                    ...
                    i.submit(function () {
                      ...
                      return (!e && !c.require_guest_email) ||
                        e.match(
                          /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
                        )
                        ? (t(S.toJSON(i)), s.close(), !1)
                        : (alert('请输入一个有效的email地址.'), !1);
                    }),
              ...
              var q = function (e) {
                s(b),
                  R.post(
                    'posts/create',
                    H.extend(S.toJSON(b), e),
                    function (e) {
                      var t = (lt[e.response.post_id] = new F(e.response)),
                        s = M(i.postList, t, c);
                      if (
                        (('asc' == c.order) == ('top' == c.formPosition) && S.scrollTo(s),
                        o.data.comments++,
                        o.updateCounter('duoshuo'),
                        k.val('').trigger('keyup'),
                        a(b),
                        g.hasClass('ds-inline-replybox') &&
                          (g.detach(), i.actionsBar.removeClass('ds-reply-active')),
                        m)
                      )
                        try {
              ...
              b.submit(function () {
                ...
                return '' == e || (!P.placeholder && e == k.attr('placeholder'))
                  ? (alert('您还没写内容呢'), !1)
                  : (r() ? T(b, q) : q(), !1);
              });
              var C = function (e) {
              ...
              if (
                (_.click(function () {
                  return (
                    H(this).toggleClass('ds-service-icon-grey').toggleClass('ds-service-icon'),
                ...
                H(y).change(function () {
                  var e = this.checked;
                  _[e ? 'removeClass' : 'addClass']('ds-service-icon-grey')[
          ...
          (st.Dialog = J.extend({
            init: function (e, t) {
              (this.el = H('#ds-wrapper'))[0] || (this.el = p(H('<div id="ds-wrapper"></div>'))),
                (this.options = H.extend({ width: 600 }, t)),
            ...
            open: function () {
              ...
              var a = this;
              return (
                a.el.hide().appendTo(t.body).fadeIn(200),
                P.ie6 && a.el.css('top', V.scrollTop() + 100),
                a.el
                  .show()
                  .find('.ds-dialog')
                  .delegate('a.ds-dialog-close', 'click', function () {
                    return a.close(), !1;
                  })
                  .click(i),
                Y.keydown(e),
            ...
            render: function () {
              function a(a) {
                ...
                if (
                  (R.post(
                    'threads/vote',
                    { thread_id: n.embedThread.threadId, vote: p ? 0 : 1 },
                    r,
                  ),
          ...
          (st.PostListHead.prototype = {
            render: function () {
              ...
              function t() {
                return (
                  n.find('a.ds-current').removeClass('ds-current'),
              ...
              var s = this.embedThread,
                a = s.postList,
                i = (this.el = H(
                  et.postListHead({ thread: s.model.toJSON(), options: s.options }),
                )),
                r = i.find('ul.ds-comments-tabs');
              r.delegate('.ds-tab a', 'click', e);
              var n = i.find('.ds-sort');
              return (
                n.delegate('a', 'click', t),
          ...
          (st.Paginator = function (e) {
            function t() {
              return (
                (i.params.page = parseInt(this.innerHTML)),
                i.refetch(),
            ...
            reset: function (e) {
              ...
              if (a > 1)
                for (
                  t(1),
                    s = a > 4 ? a - 2 : 2,
                    s > 2 && i.push('<span class="page-break">...</span>');
                  a > s;
                  s++
                )
                  t(s);
              ...
              this.el
                .html('<div class="ds-border"></div>' + i.join(' '))
                [e.pages > 1 ? 'show' : 'hide']();
            },
          }),
          ...
          (st.SmiliesTooltip.prototype = {
            render: function () {
              function e() {
                ...
                if (t.selection) {
                  (i.value =
                    r.substring(0, a.data('ds-range-start')) +
                    this.title +
                    r.substring(a.data('ds-range-end'), r.length)),
                  ...
                  (i.value =
                    r.substring(0, i.selectionStart) + this.title + r.substring(i.selectionEnd)),
            ...
            reset: function (e) {
                ...
                var i =
                  0 === e.indexOf('微博')
                    ? 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/' +
                      s.replace('_org', '_thumb')
                    : S.STATIC_URL + '/images/smilies/' + s;
                'WordPress' === e && (t = ' ' + t + ' '),
              ...
              var a = '<ul>';
              return (
                H.each(L[e], t), (a += '</ul>'), this.el.find('.ds-smilies-container').html(a), this
              );
            },
          }),
        ...
        var X = H(
          ...
          K = X.find('.ds-bubble-content').delegate('a.ds-ctx-open', 'click', function () {
            ...
            return (
              s.el.find('.ds-dialog').css('width', '600px'),
              s.el
                .find('.ds-dialog-body')
                .css({
                  'max-height': '350px',
        ...
        X.mouseenter(N).mouseleave(I),
          ...
          (st.PostList.prototype = {
            ...
            refetch: function () {
              ...
              s.el.fadeTo(200, 0.5), R.get(s.url, s.params, e);
            },
          }),
          ...
          (st.RelatedRead.prototype = {
            ...
            load: function (s) {
              (e.__duoshuo_id__ = s),
                (e.readsByToutiao = []),
                e.readsByToutiao.push({ id: 'ds-related-reads', num: 3 });
          ...
          (st.EmbedThread = Q.extend({
            ...
            render: function () {
              ...
              var t = e.width(),
                s =
                  e.data('url') ||
                  (!e.attr('data-thread-id') && H('link[rel=canonical]').attr('href'));
            ...
            updateCounter: function (e) {
              ...
              for (var a in s)
                if (!e || e == a) {
                  ...
                  this.el
                    .find('.ds-comments-tab-' + a)
                    .html(
                      this.el.hasClass('ds-narrow')
                        ? '<span class="ds-service-icon ds-' + a + '"></span>' + i
                        : (i ? '<span class="ds-highlight">' + i + '</span>' : '0') + s[a][1],
                    );
                }
            },
            onError: function (e) {
            ...
            onload: function (t) {
              ...
              (a.model = new G((a.data = t.thread))),
                ...
                t.options &&
                  t.options.show_recommend &&
                  ((a.relatedRead = new st.RelatedRead()),
                ...
                o.hot_posts &&
                  t.hotPosts &&
                  t.hotPosts.length &&
                  ((a.hotPosts = new st.HotPosts(H('<div class="ds-rounded"></div>'), {
                    max_depth: 1,
                    show_context: o.show_context,
                  })),
                  (a.hotPosts.thread = a),
                  d.append(a.hotPosts.el),
                  a.hotPosts.onload({ list: lt.getJSON(t.hotPosts) })),
                ...
                (a.paginator = new st.Paginator({ collection: a.postList })),
                a.paginator.reset(n);
              var c = (a.replybox = new st.Replybox(a));
              (c.postList = a.postList.el),
                r()
                  ? (a.loginButtons = H(et.loginButtons())
                      .delegate('a.ds-more-services', 'click', function () {
                        return a.loginButtons.find('.ds-additional-services').toggle(), !1;
                      })
                      .delegate('a.ds-service-link', 'click', l))
                  : (a.toolbar = H(et.toolbar())
                      .delegate('.ds-account-control', 'mouseenter', function () {
              ...
              'top' == o.formPosition && H.fn.append.apply(d, u),
                ...
                a.updateCounter(),
                t.alerts &&
                  H.each(t.alerts, function (e, t) {
                    H('<div class="ds-alert">' + t + '</div>').insertBefore(
                      a.toolbar || loginButtons,
                    );
                  }),
                o.message && c.el.find('textarea').val(o.message).focus(),
                ot.on('reset', function () {
                  var e = ot.data.comments || 0;
                  d.find('a.ds-unread-comments-count')
                    .html(e)
                    .attr('title', e ? '你有' + e + '条新回复' : '你没有新回复')
                    .css('display', e ? 'inline' : 'none');
                }),
                o.mzadx_id &&
                  (S.require('mzadxN', function () {}),
                ...
                r() || A.send({ visit_thread_id: a.threadId });
            },
          ...
          (st.RecentComments = Q.extend({
            ...
            params:
              'show-avatars show-time show-title avatar-size show-admin excerpt-length num-items channel-key',
            render: function () {
            ...
            render: function () {
              this.el.children().detach(),
                this.el
                  ...
                  .append((this.waitingEl = H(et.waitingImg())));
            },
          })),
          ...
          (st.LoginWidget = Q.extend({
            ...
            render: function () {
              ...
              e
                .attr('id', 'ds-login')
                .html(et.loginWidget(['weixin', 'weibo', 'qq', 'renren', 'kaixin', 'douban'])),
                e.find('a').click(l),
          ...
          (st.ThreadCount = Q.extend({
            onload: function (e) {
              ...
              t[t.data('replace') ? 'replaceWith' : 'html'](
                z[s + '_' + (a ? (a > 1 ? 'multiple' : 'one') : 'zero')].replace('{num}', a),
              );
            },
          })),
          (st.ShareWidget = Q.extend({
            ...
            delegateEvents: function () {
              ...
              if (i.children().hasClass('ds-share-inline')) {
                ...
                var l = i.children().hasClass('ds-share-aside-left')
                    ? 'slide-to-right'
                    : 'slide-to-left',
                  c = i.children();
                    ...
                    s
                      ? (e.left =
                          (t.documentElement.scrollLeft +
                            ...
                            parseInt(this.currentStyle.marginRight, 10) || 0) - 195)
                      : (e[u] = 0),
                      c.animate(e, 200);
                  }),
                      ...
                      s
                        ? (e.left =
                            (t.documentElement.scrollLeft +
                              ...
                              this.offsetWidth -
                              (parseInt(this.currentStyle.marginLeft, 10) || 0) -
                              parseInt(this.currentStyle.marginRight, 10) || 0) + 230)
                        : (e[u] = -229),
                        c.animate(e, 200);
                    });
                }
                i.delegate(
                  '.ds-share-aside-toggle,.ds-share-aside-inner',
                  'mouseover',
                  function () {
                    c.addClass(l);
                  },
